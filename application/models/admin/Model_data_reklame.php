...
class Model_data_reklame extends CI_model
{
    ...
    {
        $this->db->select('reklame.*, reklame_lokasi.*, kecamatan.kecamatan, nagari.nama_nagari');
        $this->db->from('reklame');
        $this->db->join('reklame_lokasi', 'reklame.id_reklame = reklame_lokasi.id_reklame', 'left');
        $this->db->join('kecamatan', 'reklame_lokasi.kec_pasang = kecamatan.id_kecamatan', 'left');
    ...
    public function get_id_kecamatan_by_nama($kecamatan)
    {
