<?php foreach ($pegawai->result() as $row) : ?>
    <div class="modal fade" id="DeletePegawai<?= $row->id_pegawai; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
