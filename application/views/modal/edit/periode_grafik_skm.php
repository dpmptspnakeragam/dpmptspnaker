<?php foreach ($periode_grafik_skm->result() as $row) : ?>
    <div class="modal fade" id="EditPeriodeGrafikSKM<?= $row->id_periode; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form role="form" action="<?= base_url('admin/grafik_skm/edit_periode'); ?>" method="POST" enctype="multipart/form-data">
