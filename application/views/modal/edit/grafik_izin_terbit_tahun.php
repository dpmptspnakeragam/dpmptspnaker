<?php foreach ($grafik as $row) : ?>
    <div class="modal fade" id="modalEditIzinTerbitTahun<?= $row->id_grafik; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form role="form" action="<?= base_url('admin/grafik_izin_terbit_tahun/edit'); ?>" method="POST" enctype="multipart/form-data">
