<!-- Modal Tabel IB -->
<div class="modal fade" id="ModalTabelIB" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-striped table-borderless table-hover" id="dataTable2" width="100%"
                        cellspacing="0">
