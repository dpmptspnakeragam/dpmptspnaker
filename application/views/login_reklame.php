<div class="login-box">
    <div class="card card-outline card-primary">
        ...
        <div class="card-header text-center">
            <h5 class="text-center">SIREKAM</h5>
            <h5 class="text-center"><b class="text-primary">S</b>istem
                <b class="text-primary">I</b>nformasi
                <b class="text-primary">Re</b>klame
                <b class="text-primary">K</b>abupaten
                Ag<b class="text-primary">am</b>
            </h5>
        </div>
        <div class="card-body">
            ...
            <form action="<?= base_url('login_reklame'); ?>" method="post">
