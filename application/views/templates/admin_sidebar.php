		...
		<aside class="main-sidebar sidebar-light-maroon">
			<!-- Brand Logo -->
			<a href="<?= base_url('welcome'); ?>" class="brand-link elevation-2">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
						<?php if ($this->session->userdata('username') != 'pengaduan'): ?>
							...
							<!-- Informasi -->
							<li class="nav-item">
								<a href="<?= base_url('welcome'); ?>" class="nav-link <?php if (in_array($this->uri->segment(1), ['welcome'])) echo "active"; ?>">
							...
							<!-- Manajemen Aset -->
							<li class="nav-item">
								<a href="<?= base_url('manage-aset'); ?>" class="nav-link <?php if (in_array($this->uri->segment(1), ['manage-aset'])) echo "active"; ?>">
							...
							<!-- Manajemen User -->
							<li class="nav-item">
								<a href="<?= base_url('manage-user'); ?>" class="nav-link <?php if (in_array($this->uri->segment(1), ['manage-user'])) echo "active"; ?>">
