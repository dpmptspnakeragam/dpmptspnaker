                    ...
                    <div class="card-body text-center">
                        ...
                        <span>
                            <?php foreach ($periode_grafik_skm->result() as $graph): ?>
                                ...
                                <a class="btn btn-outline-danger btn-block mt-2" href="#" data-toggle="modal"
                                    data-target="#EditPeriodeGrafikSKM<?= $graph->id_periode; ?>" title="Edit">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex mb-3">
                            <button type="button" class="btn btn-outline-danger" data-toggle="modal"
                                data-target="#ModalTambahGrafikSKM">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <button type="button" data-toggle="modal"
                                                data-target="#ModalEditGrafikSKM<?= $row->id_grafik; ?>"
                                                class="btn btn-outline-warning mt-1 mb-1">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <button type="button" data-toggle="modal"
                                                data-target="#ModalDeleteGrafikSKM<?= $row->id_grafik; ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <img src="<?= base_url('assets/imgupload/' . $data['file_name']); ?>"
                                                style="width:250px;" class="img-responsive">
                                        </td>

                                        <td class="text-center align-middle">
                                            <button type="button" data-toggle="modal"
                                                data-target="#ModalEditIKM<?= $data['id_skm_gambar']; ?>"
                                                class="btn btn-outline-warning mt-1 mb-1">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <button type="button" data-toggle="modal"
                                                data-target="#ModalDeleteIKM<?= $data['id_skm_gambar']; ?>"
                                                class="btn btn-outline-danger mt-1 mb-1">
                                                <i class="fas fa-trash-alt"></i>
                                            </button>
                                        </td>
