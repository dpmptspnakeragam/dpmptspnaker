                        ...
                        <form method="GET" action="<?= base_url('admin/skm/filter'); ?>">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-2 mt-2 align-self-end">
                                    <button type="submit" class="btn btn-block btn-outline-danger">Tampilkan
                                        Data</button>
                                </div>
                            </div>
                        </form>
                        ...
                        <table id="TabelDataPrint" class="table table-bordered table-sm table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th id="toggle-column" class="text-center align-middle" colspan="9"
                                        style="cursor: pointer;">Pendapat Responden</th>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($skm as $row): ?>
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <?= date('d-m-Y / H:i:s', strtotime($row['date'])); ?></td>
                                        ...
                                        <td class="text-center align-middle">
                                            ...
                                            <button type="button" data-toggle="modal"
                                                data-target="#deleteSKM<?= $row['id_skm']; ?>"
                                                class="btn btn-outline-danger mt-1 mb-1">
                                                <i class="fas fa-trash-alt"></i>
                                            </button>
                                            <button type="button" class="btn btn-outline-info mt-1 mb-1"
                                                onclick="printSKM(<?= $row['id_skm'] ?>)">
...
<?php foreach ($skm as $row): ?>
    <div class="modal fade" id="deleteSKM<?= $row['id_skm']; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= base_url('admin/skm/delete/' . $row['id_skm']); ?>"
...
<?php foreach ($skm as $row): ?>
    <div class="modal fade" id="detailSKM<?= $row['id_skm']; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
